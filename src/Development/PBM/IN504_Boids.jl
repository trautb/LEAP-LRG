...
export Bird, demo
"""
This model shows behaviour, that is both collective and emergent. The agents follow the rules: cohere, match and separate.
These rules will make them match their moving direction
